...
(function ($) {
    ...
    var mainApp = {
        ...
        main_fun:function() {
                ...
                $.vegas('slideshow', {
                    backgrounds: [
                      ...
                      { src: 'assets/img/2.jpg', fade: 1000, delay: 9000 }, //THESE IMAGES ARE FOR DEMO PURPOSE ONLY YOU, CAN NOT USE THEM WITHOUT AUTHORS PERMISSION
                       ...
                       { src: 'assets/img/4.jpg', fade: 1000, delay: 9000 }, //SEE DOCUMENTATION FOR ORIGINAL URLs/LINKs OF IMAGES
                       { src: 'assets/img/5.jpg', fade: 1000, delay: 9000 }, //SEE DOCUMENTATION FOR ORIGINAL URLs/LINKs OF IMAGES
                       { src: 'assets/img/6.jpg', fade: 1000, delay: 9000 }, //SEE DOCUMENTATION FOR ORIGINAL URLs/LINKs OF IMAGES
                       { src: 'assets/img/7.jpg', fade: 1000, delay: 9000 }, //SEE DOCUMENTATION FOR ORIGINAL URLs/LINKs OF IMAGES
            ...
            $(function () {
                var $header = $("#headLine");
                var header = ['LA LİGA TÜRKİYE', 'ÇOK YAKINDA!!']; // CHANGE TEXT HERE TO YOUR TEXT , YOU CAN USE MANY WORDS SEPRATED BY , 
